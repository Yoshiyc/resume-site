...
<div class="mb-8">
  <div class="flex items-center space-x-4">
    ...
    <div>
      <h1 class="text-2xl font-bold text-gray-900">編輯工作經歷</h1>
      <p class="text-gray-600 mt-1">修改工作經歷資訊</p>
    </div>
  </div>
</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div>
        ...
        <input
          ...
          id="company"
          name="company"
          value={(form as any)?.data?.company || experience?.company || ''}
          required
      ...
      <div>
        ...
        <input
          ...
          id="position"
          name="position"
          value={(form as any)?.data?.position || experience?.position || ''}
          required
          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
      ...
      <div>
        ...
        <input
          ...
          id="location"
          name="location"
          value={(form as any)?.data?.location || experience?.location || ''}
          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          placeholder="台北市, 台灣"
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          id="company_url"
          name="company_url"
          value={(form as any)?.data?.company_url || experience?.company_url || ''}
          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
      ...
      <div class="md:col-span-2">
        ...
        <input
          ...
          value={(form as any)?.data?.company_logo_url || experience?.company_logo_url || ''}
          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
      ...
      <div class="md:col-span-2">
        ...
        >{(form as any)?.data?.description || experience?.description || ''}</textarea>
      </div>
    </div>
  </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div>
        ...
        <input
          ...
          id="start_date"
          name="start_date"
          value={(form as any)?.data?.start_date || experience?.start_date || ''}
          required
          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          id="end_date"
          name="end_date"
          value={(form as any)?.data?.end_date || experience?.end_date || ''}
          disabled={isCurrent}
      ...
      <div class="md:col-span-2">
        ...
        <input
          ...
          id="technologies"
          name="technologies"
          value={(form as any)?.data?.technologies?.join(', ') || experience?.technologies?.join(', ') || ''}
          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
  ...
  <div class="bg-white rounded-lg shadow p-6">
    ...
    <div>
      ...
      <input
        ...
        id="sort_order"
        name="sort_order"
        value={(form as any)?.data?.sort_order || experience?.sort_order || 0}
        min="0"
        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        placeholder="0"
      />
